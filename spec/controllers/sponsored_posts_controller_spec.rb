...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  describe "GET show" do
    ...
    it "assigns my_sponsored_post" do
      get :show, topic_id: my_topic.id, id: my_sponsored_post.id
  ...
  describe "POST create" do
    it "increases the number of SponsoredPost by 1" do
      expect{post :create, topic_id: my_topic.id, sponsored_post: {name: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_price}}.to change(SponsoredPost, :count).by(1)
    end

    it "assigns SponsoredPost.last to @sponsored_post" do
      post :create, topic_id: my_topic.id, sponsored_post: {name: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_price}
